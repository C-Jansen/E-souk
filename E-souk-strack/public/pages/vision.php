...
<body>
    <?php include '../templates/navbar.php'; ?>  <!-- Fixed template path -->
            ...
            <div class="row align-items-center min-vh-100">
                ...
                <div class="col-lg-5 position-relative z-2 d-none d-lg-block" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
                    <div class="vision-illustration">
                         <!-- Add this inside the vision-illustration div, at the same level as the device-container -->
...
<section id="newsletter" class="newsletter-section py-5 bg-light">
    ...
    <!-- Custom Scripts -->
    <?php include '../templates/footer.php'; ?>  <!-- Fixed template path -->
    <script>
    ...
    if (file_exists(ROOT_PATH . '/public/templates/Topbtn.php')) {
        include '../templates/Topbtn.php';
    }
    if (file_exists(ROOT_PATH . '/public/templates/newsletter.php')) {
