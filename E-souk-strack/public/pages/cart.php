                    ...
                    <div class="card-body p-4">
                        <?php if (empty($_SESSION['cart'])): ?>
                            <div class="text-center py-5">
                                ...
                                <a href="product.php" class="btn btn-primary mt-3">Explorer les produits</a>
                            </div>
                        <?php else: ?>
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm sticky-top" style="top: 20px; z-index: 1">
                    <div class="card-body p-4">
                        ...
                        <a href="<?= empty($_SESSION['cart']) ? '#' : 'checkout.php' ?>" 
                           class="btn btn-primary w-100 mt-4 py-2 <?= empty($_SESSION['cart']) ? 'disabled' : '' ?>">
