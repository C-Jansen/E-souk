...
function isInWishlist($productId) {
    return isset($_SESSION['wishlist']) && in_array($productId, $_SESSION['wishlist']);
}
                        ...
                        <?php foreach ($filtered_products as $product): ?>
                            <div class="col-md-4 col-6">
                                <div class="card h-100 product-card">
                                    ...
                                    <button class="wishlist-btn" onclick="toggleWishlist(<?= $product['id_product']; ?>, this)" 
                                            data-product-id="<?= $product['id_product']; ?>">
                                        <i class="fas fa-heart <?= isInWishlist($product['id_product']) ? 'active' : ''; ?>"></i>
                                    </button>
