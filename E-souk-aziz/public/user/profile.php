...
$profileImageQuery = $db->prepare("SELECT image FROM user WHERE id_user = ?");
$profileImageQuery->execute([$user_id]);
$profileImageDB = $profileImageQuery->fetchColumn();
                ...
                <div class="profile-header shadow-sm">
                    <div class="row">
                        <div class="col-md-3 text-center mb-3 mb-md-0">
                            <img src="<?= ROOT_URL ?>root_uploads/users/profile-pic/<?= htmlspecialchars($profileImage) ?>" class="profile-image" alt="Profile Image">
                        </div>
                        <div class="col-md-9">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card text-center h-100 stats-card shadow-sm">
                            ...
                            <div class="card-footer bg-transparent">
                                <a href="reviews.php" class="text-decoration-none">View Reviews</a>
                            </div>
                        </div>
                    </div>
                </div>
